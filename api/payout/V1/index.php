...
if(!empty($_POST)){
    ...
    if($curr=='CNY'){
        ...
        <script type="text/javascript" language="JavaScript" src="https://payin.pay2rax.com/api/payout/V1/sha1.js"></script>
        ...
        <form action="https://payment.quicktransfer.asia/Credit" method="POST">
                ...
                <!-- serverReturnURL -->
                  <input id="serverreturnurl" name="serverreturnurl" type="hidden" value="https://payin.pay2rax.com/payout/payout_response_url.php">                 
